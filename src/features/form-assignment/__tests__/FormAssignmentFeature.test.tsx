...
import FormAssignmentFeature, { FormAssignmentValues } from '@/features/form-assignment';

describe('FormAssignmentFeature', () => {
  test('renderiza campos principales del formulario', () => {
    render(<FormAssignmentFeature formularios={[]} usuarios={[]} onAssign={function (values: FormAssignmentValues): void {

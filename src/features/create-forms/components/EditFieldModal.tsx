...
const EditFieldModal: FC<EditFieldModalProps> = ({
  ...
  const valor_inicial = ['Sin valor', 'Fecha/Hora actual']
      ...
      <Form form={form} layout="horizontal" onFinish={handleFinish}>
        ...
        <div className='flex flex-row gap-10'>
            <Form.Item
                label="Etiqueta"
                name="etiqueta"
                rules={[{ required: true, message: 'Por favor ingresa la etiqueta' }]}
            >
        ...
        <div className='flex gap-16'>
            <div className='flex flex-col pl-2 w-1/2'>
                <Form.Item label="Color"name="color" initialValue="#000000" className='w-full'>
                ...
                {variant === "fecha" &&
                  <Form.Item label="Valor inicial" name="opciones" initialValue={"Sin valor"} className='w-full'>
                    <Select>
        ...
        <Form.Item
          label="Regla de Visualización"
          name="reglaVisualizacion"
        >

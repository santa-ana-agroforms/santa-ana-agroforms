...
describe('ApprovalRoutesPage', () => {
  test('renderiza la tabla de rutas con columnas básicas', () => {
    ...
    expect(screen.getByRole('columnheader', { name: /Route Id/i })).toBeInTheDocument();
    ...
    expect(screen.getByRole('columnheader', { name: /Campo 1/i })).toBeInTheDocument();
    expect(screen.getByRole('columnheader', { name: /Campo 2/i })).toBeInTheDocument();
    expect(screen.getByRole('columnheader', { name: /Activo/i })).toBeInTheDocument();
  });
});
